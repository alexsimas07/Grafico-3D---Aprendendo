# DEFINIÇÃO DE PROBLEMA ESTÁ NO MANUAL EM PDF DO CAP 15
# iNSTALANDO OS PACOTES PARA O PROJETO
# OBS: OS PACOTES PRECISAM SER INSTALADOS APENAS UMA VEZ

getwd()

#install.packeges("ggplot2") e ("dplyr") - ja possui
...
# Carregando o dataset na pasta dados dentro do Cap 15

dados_clientes <- read.csv("dados/dataset.csv")

# Visualizando os dados e sua estrutra
...
############### Machine Learning - Amostragem estratificada #################
...
# com números de indice de linha ( conforme idenficado acima) e todas as colunas

dados_treino <- dados_clientes[indice,]
dim(dados_treino)
table(dados_treino$inadimplente)

# Veja porcentagem entre classes
...
# Melt(derreter) data - Converte colunas em linhas
?reshape2::melt
...
# Precisamos instalar o pacotes auxiliares 
...
install.packages("DMwR") # Pacote instalado manualmente 
library(DMwR)
?SMOTE
...
########################Segunda Vers�o do Modelo - machine learning ##############
...
# Criando o rank de vari�veis baseado na importancia 

rankImportance <- varImportance %>%
  mutate(Rank = paste0('#', dense_rank(desc(Importance))))

# Usando ggplot2 parar visualizar a import�nica relativa das vari�veis
...
# Previ�es com novos dados de 3 Clientes
# Dados dos clientes
...
novos_clientes <- data.frame(PAY_0, PAY_2, PAY_3, PAY_AMT1, PAY_AMT2, PAY_5, 
                             BILL_AMT1)
View(novos_clientes)
...
# Checando os tipos de dados - Erro por causa de Fator / NUM
